        ...
        <div>
            <Grid container justify="center" alignItems="center">
                <Grid item xs={12} sm={12} md={6}>
                    <Paper elevation={10} className={classes.paper}style={{backgroundImage: user.cover_image ? 'url(' + user.cover_image + ')': null,}}>
            ...
            <Grid container justify="center" alignItems="center" style={{ marginTop: '30px' }}>
                <Grid item xs={12}sm={12} d={6} style={{display: 'flex',flexDirection: 'column',justifyContent: 'center',alignItems: 'center',marginBottom: '16px',}}>  
