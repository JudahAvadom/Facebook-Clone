import { Paper, Grid, Divider, AppBar, Tabs, Tab, Box } from '@mui/material';
            ...
            <Paper style={{width: '100%',backgroundColor: uiState.darkMode && 'rgb(36,37,38)',}}>
                ...
                <Grid container justify="center" alignItems="center">
                    <Grid item xs={12} sm={12} md={6}>
                        <Divider />
                        <AppBar elevation={0} position="static" style={{
                                background: uiState.darkMode ? 'rgb(36,37,38)' : '#fff',
                                color: uiState.darkMode ? '#fff' : 'black',
                                alignItems: 'center',
                            }}
                            >
                                <Tabs value={value} onChange={handleChange} variant="scrollable" scrollButtons= {true} indicatorColor="primary">
                                    <Tab label="Timeline" />
